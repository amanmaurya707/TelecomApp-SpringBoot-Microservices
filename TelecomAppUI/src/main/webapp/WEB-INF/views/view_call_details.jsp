 ...
 margin-top: auto;
  ...
  <body>
	...
	<ol class="navbar-nav mx-auto mb-2 mb-lg-0 mr-4 py-4 text-center breadcrumb ml-4">
  	<li class="active" aria-current="page">View Call Details||</li>
...
<div class="row">
    <div class="col-12 container">
             <div class="col-12 mx-auto text-center pt-4" style="background-color:#F2F4F4 ;">
                <h2 style="color:#ABB2B9;">See Call Details Here</h2><hr>
                ...
                <table class="table table-bordered tbl" id="mydata">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">CalledTo</th>
                        <th scope="col">CalledOn</th>
                        <th scope="col">DurationInSeconds</th>
                       
                      </tr>
                    </thead>
                    <tbody id="result">
                    
                     <c:forEach items="${callData}" var="call">
                     <tr>
                      <td><c:out value="${call.calledBy}"/></td>
                      <td><c:out value="${call.calledTo}"/></td>
                      <td><c:out value="${call.calledOn}"/></td>
                      <td><c:out value="${call.durationInSeconds}"/></td>
                      </tr>
                      </c:forEach>  
